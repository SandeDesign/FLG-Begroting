...
export const HANDBOEK: HandboekHoofdstuk[] = [
  ...
  },
  {
    ...
    onderwerpen: [
      ...
      {
        id: 'middel-toevoegen',
        titel: 'Een middel toevoegen',
        kort: 'Bus, heftruck, gereedschap of laptop — alles wat kosten draagt',
        tekst: [
          'Een middel is niet per se een auto. Het is alles wat geld kost om de opdracht te kunnen uitvoeren. Bovenaan kies je wat voor soort het is: **voertuig**, **materieel**, **gereedschap**, **ICT** of **overig**.',
          'Alleen bij een **voertuig** splits je de kosten uit naar brandstof, verzekering, wegenbelasting en onderhoud. Daar zit bij een bus namelijk het verschil, en daar kun je onderhoud ook uit de kilometers laten berekenen.',
          'Bij alle andere soorten vul je de financiering in plus één bedrag: **bijkomende kosten**. Bij een heftruck of een laptop zegt een uitsplitsing naar brandstof en wegenbelasting niets extra\'s — vier velden die je toch op nul laat staan maken het scherm alleen langer.',
          'Posten die bij een soort niet bestaan verdwijnen uit beeld én worden op nul gezet, ook bij een middel dat je eerder al had opgeslagen. Er telt dus nooit een bedrag mee dat je nergens ziet staan.',
          'Een middel hoort bij een opdracht, of bij de entiteit zelf als het niet aan één opdracht toe te wijzen is.',
          'Kies daarna de financiering:',
          ...
          'Onderhoud uit de kilometers laten berekenen kan alleen bij een voertuig; een heftruck of een laptop rijdt geen kilometers over de weg.',
