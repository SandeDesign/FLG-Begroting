  ...
  },
  {
    ...
    onderwerpen: [
      ...
      },
      {
        ...
        tekst: [
          'Een middel is niet per se een auto. Het is alles wat geld kost om de opdracht te kunnen uitvoeren. Bovenaan kies je wat voor soort het is, en dáár passen de kostenposten zich op aan:',
          '- **Voertuig** — een bus, auto of aanhanger. Met brandstof en wegenbelasting.',
          '- **Materieel** — een heftruck, machine, container of steiger. Wel energie en onderhoud, geen wegenbelasting.',
          ...
          'Posten die bij een soort niet bestaan verdwijnen uit beeld én worden op nul gezet. Er telt dus nooit een bedrag mee dat je niet ziet staan: wegenbelasting op een laptop kan simpelweg niet blijven hangen.',
